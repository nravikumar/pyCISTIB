...
class BuildNetwork(object):
    ...
    def cnn_3d(self):
        ...
        c1 = Conv3D(128,kernel_size=(1,1,1),strides=self.stride, padding='same',
        ...
        # f = Flatten()(c1)
        gp = GlobalMaxPooling3D()(c1)
        FC1 = Dense(32,activation=self.activation, kernel_initializer=keras.initializers.he_normal(seed=7))(gp)
        #DP1 = Dropout(0.5)(FC1)
